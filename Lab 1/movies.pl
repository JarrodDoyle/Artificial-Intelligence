...
movie(solo_test, 2006).
actress(solo_test, scarlett_johansson, catherine).

movie(multi_role_test, 2006).
actress(multi_role_test, scarlett_johansson, role1).
actress(multi_role_test, scarlett_johansson, role2).